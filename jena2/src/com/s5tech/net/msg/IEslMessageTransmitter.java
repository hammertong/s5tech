...
public interface IEslMessageTransmitter {

	/**
	 * This method wraps a pdu in an {@link EslMessage} an sends it to a specific esl
	 * TODO this should go be sent async; ie. when there's space in the nwkCtrl's buffer
	 * @param esl
	 * @param message
	 * @return
	 */
