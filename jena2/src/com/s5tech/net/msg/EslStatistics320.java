...
public class EslStatistics320 
		extends EslStatistics
    ...
    typedef struct
	{
	        ...
	        uint16 nScan;
	        uint32 timestamp;
	        uint8  nJoinWDT; // watch dog timer, quante volte ha resettato l'esl
	} stat_send_t;
	*/
    
    protected int  nJoinWDT;
