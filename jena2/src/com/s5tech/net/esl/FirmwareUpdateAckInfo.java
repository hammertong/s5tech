...
public class FirmwareUpdateAckInfo extends MessageInfo<EUI64Address>{

	private static final long serialVersionUID = -4582546212153842049L;
	
	public FirmwareUpdateAckInfo(String msgId) {
		super (true, msgId, null, MessageCommand.ESLFIRMWAREUPDATE);
	}
