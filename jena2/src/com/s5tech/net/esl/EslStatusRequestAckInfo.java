...
public class EslStatusRequestAckInfo extends MessageInfo<EUI64Address>{

	private static final long serialVersionUID = -4582546212153842049L;
	
	public EslStatusRequestAckInfo(String msgId) {
		super (true, msgId, null, MessageCommand.ESLSTATUSREQUEST);
	}
