...
public interface IEslEntityManager {

	public Map<EUI64Address, EslDeviceInfo> getEsls();
	public EslDeviceInfo getEslInfoByMac(EUI64Address eslMac);
	
	public void shutdown();	
	public void addEsls(Collection<EslDeviceInfo> esls);
	public void removeEsls(Collection<EUI64Address> eslMacs);
	
	public void update (EslDeviceInfo device);
	public boolean isAllowed(EUI64Address eslmac);
	
	public void updateAssociation (EUI64Address coordinator, Collection<EUI64Address> eslslist);
